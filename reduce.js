...
function vowelCount(str) {
    ...
    return strArray.reduce(function(acc, nextChar) {
        if(vowels.includes(nextChar)) {
            acc[nextChar] ? acc[nextChar] += 1 : acc[nextChar] = 1;
        } return acc;    
    }, {})
}
...
specific value is true, the value should be placed in the first subarray. If the 
result of the callback function at that specific value is false, the value should be 
